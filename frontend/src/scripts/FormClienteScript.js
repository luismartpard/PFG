...
export default {
    ...
    methods: {
        nuevoCliente() {
            this.clienteService.nuevoCliente(this.cliente).then((data) => {
                if (data.status === 200) {
        ...
        checkForm() {
            ...
            if (document.getElementById("dni").value != "") {
                this.clienteService.existeDni(document.getElementById("dni").value).then((data) => {
                    if (data.data === false) {
                        return true;
                    } else {
                        document.getElementById("dni").classList.add("p-invalid");
            ...
            if (document.getElementById("telefono").value != "") {
                this.clienteService.existeTelefono(document.getElementById("telefono").value).then((data) => {
